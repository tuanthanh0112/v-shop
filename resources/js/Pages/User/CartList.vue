...
import UserLayouts from '../User/Layouts/UserLayout.vue';
                  ...
                  <div v-else>
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <button v-if="formFilled || userAddress" type="submit"
                            class="text-white w-full bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Checkout</button>

                        <button v-else type="submit"
                            class="text-white w-full bg-gray-500 border-0 py-2 px-6 focus:outline-none hover:bg-gray-600 rounded text-lg">Add
